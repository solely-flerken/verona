...
export const menuData: MenuCategory[] = [
    {
        ...
        name: 'Pizza',
        items: [
            {id: 'margherita', name: 'Margherita', description: 'Tomatensauce, Mozzarella, Basilikum', price: '8,50 €'},
            {id: 'salami', name: 'Salami', description: 'Tomatensauce, Mozzarella, italienische Salami', price: '9,50 €'},
            {id: 'diavolo', name: 'Diavolo', description: 'scharfe Salami, Peperoni, rote Zwiebeln', price: '10,50 €'},
            {id: 'verona-speciale', name: 'Verona Speciale', description: 'Parmaschinken, Rucola, Parmesan, Kirschtomaten', price: '12,50 €'},
            {id: 'funghi', name: 'Funghi', description: 'frische Champignons, Mozzarella', price: '9,00 €'},
            {id: 'tonno', name: 'Tonno', description: 'Thunfisch, rote Zwiebeln, Oliven', price: '10,00 €'},
            {id: 'quattro-formaggi', name: 'Quattro Formaggi', description: 'vier italienische Käsesorten', price: '11,00 €'},
